...
import { useListNotes, useCreateNote, useDeleteNote, useListSubjects } from '@workspace/api-client-react';
...
import { Plus, Trash2, Search, ExternalLink, FileText, Loader2, ChevronLeft, ChevronRight, Download } from 'lucide-react';
...
export default function AdminNotes() {
  ...
  const { data, isLoading } = useListNotes({ page, limit: 20, ...(search && { search }) });
